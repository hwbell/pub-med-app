...
const aboutPageText = {
  ...
  full: {
    ...
    use all the features of the site.`,
          ...
          useful! You can quickly create & export resource lists from your literature searches so you 
          can keep a record of your research.`,
          `If you are looking to connect with other researchers to discuss publications or other topics,
    you will want to explore the threads page! Read more below about collections and threads below.`
        ]
      },
      {
        title: 'Collections',
    ...
    free or behind a subscriber paywall).`,
      `As of December 2018, the PMC archive contained over 5.2 million 
